...
{!! Form::model($empleados, ['route' => ['empleados.update',$empleados->id],'method'=>'PUT']) !!}
		...
		<div class="form-group">
			...
			{!! Form::select('id_turno',$turnos,$empleados->id_turno,['class' => 'form-control'])!!}
 		</div>
 		<div class="form-group">
			{!! Form::label('id_departamento', 'Departamento') !!}
			{!! Form::select('id_departamento',$departamentos,$empleados->id_departamento,['class' => 'form-control'])!!}
 		</div>
